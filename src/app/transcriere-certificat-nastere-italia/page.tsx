...
const faqItems = [
  { question: 'Ce documente aduc pentru transcrierea certificatului de naștere italian?', answer: 'Varianta recomandată: extrasul multilingv "Formule A" sau alt extras multilingv emis de autoritățile italiene, fără apostilă și fără traducere. Alternativ: certificatul italian de naștere, cu apostilă Haga și traducere autorizată în română.' },
...
const howToSteps = [
  { name: 'Pregătește documentul copilului', text: 'Recomandare: extrasul multilingv "Formule A" sau echivalentul multilingv emis de autoritățile italiene, fără apostilă sau traducere. Alternativă: certificatul italian de naștere, cu apostilă și traducere.' },
