...
const GUIDE_TITLES: Record<string, string> = {
  ...
  'pasaport-crds-it': 'Reînnoire pașaport CRDS · Italia',
  'pasaport-crds-it-pierdut': 'Pașaport CRDS pierdut/furat · Italia',
  'pasaport-crds-nou-it': 'Primul pașaport CRDS · Italia',
  'pasaport-minor-crds-it': 'Pașaport copil CRDS · Italia',
  'pasaport-it-cu-domiciliu': 'Pașaport · Domiciliu România · Italia',
  'pasaport-it-cu-domiciliu-pierdut': 'Pașaport pierdut/furat · Italia',
  'buletin-it-fara-domiciliu': 'Buletin expirat · Fără domiciliu RO · Italia',
  'buletin-it-cu-domiciliu': 'Buletin expirat · Domiciliu activ RO · Italia',
  'buletin-it-fara-domiciliu-pierdut': 'Buletin pierdut/furat · Fără domiciliu RO · Italia',
  'buletin-it-cu-domiciliu-pierdut': 'Buletin pierdut · Domiciliu activ RO · Italia',
  'buletin-it-primul-it': 'Primul buletin românesc · Italia',
  'buletin-it-primul-it-b': 'Primul buletin românesc · Italia',
  'titlu-calatorie-urgenta-it': 'Titlu de călătorie · Urgență · Italia',
  'titlu-calatorie-it': 'Titlu de călătorie · Italia · 1–2 săptămâni',
  'procura-vanzare-it': 'Procură de vânzare/cumpărare proprietate · Italia',
