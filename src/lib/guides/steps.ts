...
const STEPS: Record<string, TrackerStep[]> = {
  ...
  'pasaport-crds-uk': STEPS_PASAPORT,
  'pasaport-uk-cu-domiciliu': STEPS_PASAPORT,
  'pasaport-crds-uk-pierdut': STEPS_PASAPORT,
  'pasaport-uk-cu-domiciliu-pierdut': STEPS_PASAPORT,
  'pasaport-minor-crds-uk': STEPS_PASAPORT,
  'pasaport-minor-ro-uk': STEPS_PASAPORT,
  'pasaport-temporar-uk': STEPS_PASAPORT,
  'titlu-calatorie-uk': STEPS_TITLU_URGENTA,
  'titlu-calatorie-minor-sub14-uk': STEPS_TITLU_URGENTA,
  'titlu-calatorie-minor-14-18-uk': STEPS_TITLU_URGENTA,
  'procura-ci-uk': STEPS_PROCURA,
  'procura-generala-uk': STEPS_PROCURA_GENERALA,
  'prima-ci-minor-uk': STEPS_BULETIN_PRIMUL,
  'prima-ci-adult-uk': STEPS_BULETIN_PRIMUL,
  'transcriere-nastere-minor-uk': STEPS_TRANSCRIERE_NASTERE,
  'transcriere-nastere-adult-uk': STEPS_TRANSCRIERE_NASTERE,
  'transcriere-casatorie-uk': STEPS_TRANSCRIERE_NASTERE,
