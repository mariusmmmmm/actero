...
export const consulates: Record<ConsulateId, ConsulateInfo> = {
  bonn: {
    ...
    schedulePassportPickup: 'Luni–Joi 14:00–15:00 (fără programare)',
    scheduleTitluCalatorie: 'Luni–Vineri 09:00–12:00 (fără programare)',
    scheduleTravelDoc: 'Luni–Vineri 09:00–12:00 (fără programare)',
    paymentMethod: 'exclusiv EC-Karte (card debit bancă germană)',
    paymentPassport: 'exclusiv EC-Karte (card debit bancă germană)',
    paymentNotarial: 'virament bancar în avans pentru taxa de 3€ RNNEPR',
    paymentNotarialNote: 'Pentru procurile notariale, IBAN-ul specific apare în econsulat la programare; regula generală este plata în avans.',
    postalPickup: false,
    pasaportSearchUrl: 'https://bonn.mae.ro/cauta-pasaport',
    staffShortageNotice: true,
    fotografiiLaGhiseu: false,
    starecivilaProgramRidicare: 'Luni–Joi 14:00–15:00',
    starecivilaPosta: false,
    starecivilaTermen: '7–30 zile',
    certNastereParintiRegula: 'if_ci_lacks_birthplace',
  ...
  muenchen: {
    ...
    schedulePassportPickup: 'Luni–Joi 14:00–16:00 (fără programare)',
    scheduleTitluCalatorie: 'În programul normal, fără programare · depunere + eliberare în aceeași zi',
    scheduleTravelDoc: 'În programul normal, fără programare · depunere + eliberare în aceeași zi',
    paymentMethod: 'exclusiv numerar (cash)',
    paymentPassport: 'exclusiv numerar (cash)',
    paymentNotarial: 'virament bancar în avans pentru taxa de 3€ RNNEPR',
    paymentNotarialNote: 'Pentru procurile notariale, IBAN-ul specific apare în econsulat la programare; regula generală este plata în avans.',
    postalPickup: true,
    ...
    starecivilaProgramRidicare: 'Luni/Miercuri/Joi 11:00–14:00 · Marți 15:00–18:00',
    starecivilaPosta: false,
    starecivilaTermen: 'aceeași zi posibilă pentru cazuri simple',
    certNastereParintiRegula: 'if_both_romanian',
  ...
  stuttgart: {
    ...
    schedulePassportPickup: 'Luni–Vineri 10:00–14:00 (fără programare)',
    scheduleTitluCalatorie: 'Luni–Vineri 10:00–14:00 (fără programare) · depunere + procesare în același interval',
    scheduleTravelDoc: 'Luni–Vineri 10:00–14:00 (fără programare) · depunere + procesare în același interval',
    ...
    paymentPassport: 'POS (EC-Karte) la ghișeu sau transfer bancar în avans',
    paymentNotarial: 'POS (EC-Karte) la ghișeu sau virament bancar în avans pentru taxa de 3€ RNNEPR',
    paymentPassportNote: 'Transfer: IBAN DE04 1007 0000 0976 1909 01 · BIC DEUTDEBBXXX · cu cel puțin 3 zile înainte',
    paymentNotarialNote: 'Pentru taxa de 3€ RNNEPR: POS la ghișeu sau virament bancar în avans la IBAN DE04 1007 0000 0976 1909 01 · BIC DEUTDEBBXXX.',
    postalPickup: true,
    postalPickupUrl: 'https://stuttgart.mae.ro/local-news/1015',
    pasaportSearchUrl: 'https://stuttgart.mae.ro/cauta-pasaport',
    staffShortageNotice: false,
    fotografiiLaGhiseu: false,
    starecivilaProgramRidicare: 'Luni–Vineri 14:00–15:00',
    starecivilaPosta: true,
    starecivilaTermen: null,
    certNastereParintiRegula: 'if_unmarried',
    formularPrintLaConsulat: true,
  ...
  berlin: {
    ...
    schedulePassportPickup: 'Luni–Vineri 13:00–14:00 (fără programare)',
    scheduleTitluCalatorie: 'Luni–Vineri 08:00–10:00 (fără programare)',
    scheduleTravelDoc: 'Luni–Vineri 08:00–10:00 (fără programare)',
    paymentMethod: '⚠️ Verificați metoda de plată direct la ghișeu',
    paymentPassport: 'card de debit la ghișeu sau virament bancar în avans',
    paymentNotarial: 'numai virament bancar în avans pentru taxa de 3€ RNNEPR',
    paymentPassportNote: 'Pașapoarte: Botschaft von Rumänien · IBAN DE83 1007 0000 0435 4429 00 · BIC DEUTDEBBXXX · Deutsche Bank Berlin.',
    paymentNotarialNote: 'Notarial 3€ RNNEPR: Botschaft von Rumänien · IBAN DE83 1007 0000 0435 4429 00 · BIC DEUTDEBBXXX · Deutsche Bank Berlin.',
    postalPickup: false,
    pasaportSearchUrl: 'https://berlin.mae.ro/cauta-pasaport',
    staffShortageNotice: false,
    fotografiiLaGhiseu: false,
    starecivilaProgramRidicare: 'Luni–Vineri 13:00–14:00',
    starecivilaPosta: false,
    starecivilaTermen: null,
    certNastereParintiRegula: 'always_required',
    patronimicWarning: true,
